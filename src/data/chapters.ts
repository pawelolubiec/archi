...
export const chapters: Chapter[] = [
  {
    ...
    activeFlows: ['de_to_factory', 'fr_to_factory', 'it_to_factory', 'us_to_factory'],
    activeSystems: [],
    kpiPanel: false,
  },
  {
  ...
  },
  {
    ...
    scene: 'globe',
    eyebrow: 'Sales',
    title: 'Germany office · CRM',
    description:
      'Zooming into the DACH market. Salesforce manages customers, pipeline, forecast, quotes, and complaints.',
    businessMessage:
  ...
  },
  {
    ...
    cameraPosition: [2.2, 3.6, 4.2],
    cameraTarget: [0.9, 1.5, 0.3],
    visibleLocations: ['office_germany', 'factory_poland'],
